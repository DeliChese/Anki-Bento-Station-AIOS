> ⚠️ **DEPRECATED** — Nội dung dưới đây mô tả cấu trúc cũ (V16, monolith) và đã lỗi thời. Hãy dùng:
> - **Nâng cấp/bảo trì/release:** [`.claude/skills/11-upgrade-playbook/SKILL.md`](.claude/skills/11-upgrade-playbook/SKILL.md)
> - **Sửa bug:** [`.claude/skills/12-debugging/SKILL.md`](.claude/skills/12-debugging/SKILL.md)
> - **Điểm vào:** [`AGENTS.md`](AGENTS.md) → [`.claude/CLAUDE.md`](.claude/CLAUDE.md)
